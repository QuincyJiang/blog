...
//        mConfStartTime.setText(confInfo.getConfInfo().getStrBeginTime()+"-"+confInfo.getConfInfo().getStrEndTime());
    ...
    protected void initView() {
        refreshLayout = $(R.id.sr_refresh_layout);
        mConfHost = $(R.id.tv_conf_host);
        mConfTheme = $(R.id.tv_conf_theme);
        mConfStartTime = $(R.id.tv_conf_time);
        mConfCOntrol = $(R.id.tv_conf_control);
        mConfEdit = $(R.id.iv_conf_edit);
        mConfNum = $(R.id.tv_conf_num);
        mConfPwd = $(R.id.tv_conf_pwd);
        mConfType = $(R.id.tv_conf_type);
        addMembers = $(R.id.tv_conf_add_members);
        mConfMemberList = $(R.id.rv_member_list);
        controlMemberRecycler = $(R.id.rv_control_members);
        mConfEdit.setOnClickListener(this);
        addMembers.setOnClickListener(this);
        mConfCOntrol.setOnClickListener(this);
        icNoConf = $(R.id.iv_no_conf);
        requestBean = new QueryInfoRequestBean();
